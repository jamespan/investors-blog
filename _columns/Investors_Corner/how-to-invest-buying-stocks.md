...
When it comes to how to invest and [The IBD Methodology](https://www.investors.com/how-to-invest/investors-corner/stock-market-investing-ibd-methodology/), we talk a lot about [position sizing](https://www.investors.com/how-to-invest/investors-corner/calculating-position-size-for-portfolio-management/). There are various ways to determine an initial position size, based on your conviction in a given stock and the overall market. Once you have that, you can add to your position as the stock passes new bullish entries or pulls back.
...
Normally, when we're building a position, we use a [pyramiding style](https://www.investors.com/how-to-invest/investors-corner/how-to-invest-in-stocks-pyramid-into-a-winning-position/): You start with half the shares you plan to buy, then each subsequent buy is a little smaller. That makes it so the average cost of the position doesn't go up too much.
