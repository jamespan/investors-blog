...
That day-to-day comparison is plotted with a blue line in [IBD Charts](https://research.investors.com/stock-charts/nasdaq-amazoncom-amzn.htm?cht=pvc&type=daily) and the premium [IBD MarketSurge](https://get.investors.com/marketsurge/?artProdLink=MarketSurge). That gives investors an easy way to visualize relative performance. A line trending higher means the stock is beating the S&P 500; a line trending lower is lagging the stock market.
...
One of the most useful applications is in [evaluating breakouts](https://www.investors.com/how-to-invest/investors-corner/what-is-stock-breakout/). When a stock tops the [buy point](https://www.investors.com/how-to-invest/investors-corner/buy-point-rule-how-teslas-34-gain-could-have-turned-to-43-profit/) of a proper base, the relative strength line should be making new highs. It's even more bullish if the RS line goes into new highs before the stock does. The Blue Dot in MarketSurge charts shows stocks with bullish base and RS line combinations.
...
[MarketSurge adds tools](https://get.investors.com/marketsurge/?artProdLink=MarketSurge) to supercharge the relative strength line. Users can add a moving average to the RS line to detect changes in price trends. A rule of thumb is to set the daily moving average at 21 and 50 days, and the weekly chart at eight and 21 weeks.
...
![amzn](https://www.investors.com/wp-content/uploads/2024/04/IC042924-300x171.jpg)In 2020, when the Covid-19 pandemic disrupted retailing, **Amazon.com** ([AMZN](https://research.investors.com/quote.aspx?symbol=AMZN)) emerged as one of the sector's big winners. Consumers used online shopping to avoid the limited access to stores, and lockdowns caused Americans to splurge on home comforts.
