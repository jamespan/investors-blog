...
The Sponsorship Rating can be found on the IBD MarketSurge weekly chart in the fundamental databoxes and in the [IBD Stock Screener.](https://ibdstockscreener.investors.com/)

Another sign of institutional sponsorship is when the number of funds owning the stock rises in the most recent quarters. Ideally, you should see an increase in fund ownership quarter over quarter. This data can be found in MarketSurge or in [IBD Stock Checkup.](https://research.investors.com/stock-checkup/)

IBD's Sponsorship Rating should not be confused with the [Accumulation/Distribution Rating](https://www.investors.com/how-to-invest/investors-corner/how-to-buy-stocks-accumulation-distribution-rating-shows-professionals-moves/). The latter uses price and volume action over the last 13 weeks, using volume as an indicator of institutional activity in the stock.

## How To Buy Stocks: Tracking Top Mutual Funds

For a deeper look at sponsorship, an essential resource is the Owners & Funds section of [IBD MarketSurge](https://get.investors.com/marketsurge/), located in the pullout panel to the right of every chart. It includes the percentage of the stock owned by funds, fund ownership totals over eight quarters, and which funds in the IBD Mutual Fund Index hold it.

Use the [0MUTI](https://research.investors.com/stock-charts/nyse-ibd-mutual-fund-index-0muti.htm) (zero) symbol to discover the IBD Mutual Fund index using [IBD Charts](https://research.investors.com/stock-charts/nyse-ibd-mutual-fund-index-0muti.htm?cht=pvc&type=daily) or [IBD MarketSurge.](https://get.investors.com/marketsurge/) In MarketSurge you can see the 20 funds that make up the IBD Mutual Fund index, including the vaunted Fidelity Contrafund (FCNTX).
...
![](https://www.investors.com/wp-content/uploads/2025/01/ICtable011325-268x300.jpg)For example, the Fidelity Contrafund's two largest positions are **Meta Platforms** ([META](https://research.investors.com/quote.aspx?symbol=META)) and **Nvidia** ([NVDA](https://research.investors.com/quote.aspx?symbol=NVDA)). Meta is a whopping 15.7% position in the latest reporting period, while Nvidia is an 8.7% position, per MarketSurge.
...
_Be sure to follow Scott Lehtonen on X_ _at [@IBD_SLehtonen](https://www.twitter.com/IBD_SLehtonen) for more on how to buy stocks, the Dow Jones Industrial Average and the stock market today._
