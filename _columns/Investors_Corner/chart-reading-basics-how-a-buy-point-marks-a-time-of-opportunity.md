...
Foreseeing the move by a stock with terrific fundamentals (the [C and A in IBD's CAN SLIM investing model](https://www.investors.com/ibd-university/can-slim/)), a No. 1 ranking in its industry, and loads of fund sponsorship, before it happens is crucial. If such a stock [breaks out with force](https://www.investors.com/how-to-invest/investors-corner/what-is-stock-breakout/), then you're more likely to grab shares at the proper buy point.
...
Those who read Investor's Corner regularly have a strong command of one of the most important patterns in growth investing: the [cup with handle](https://www.investors.com/how-to-invest/investors-corner/the-basics-how-to-analyze-a-stocks-cup-with-handle/). The pattern allows you to be consistent in your buying. You're essentially entering a stock only when it's reached the point at which it can rise fast in a relatively short time frame.
...
Human nature hasn't changed. Greed and fear still drive the market. So the [cup with handle](https://www.investors.com/how-to-invest/investors-corner/the-basics-how-to-analyze-a-stocks-cup-with-handle/) and other useful patterns of investor behavior will continue to pop up among IBD's wide span of features and screens designed to help you find and buy great stocks at the right time.

Make a habit of going through the stocks presented in [IBD 50](https://research.investors.com/stock-lists/ibd-50/), [Big Cap 20](https://research.investors.com/stock-lists/big-cap-20/), [Stock Spotlight](https://research.investors.com/stock-lists/stock-spotlight/), [Sector Leaders](https://research.investors.com/stock-lists/sector-leaders), [IPO Leaders](https://research.investors.com/stock-lists/ipo-leaders/) and [Stocks Near A Buy Zone](https://www.investors.com/category/stock-lists/stocks-near-a-buy-zone/). Most of these can be accessed via [Stock Lists](https://www.investors.com/stock-lists/stocks-to-watch-top-rated-ipos-big-caps-and-growth-stocks/) on the home page at Investors.com. (See the Income Investor columns by clicking on "Research" on the main navigation bar on the home page.)
...
Are you completely new to chart analysis, or want to bring your skills up a notch? Check out the real-time annotations done in [Leaderboard](https://leaderboard.investors.com/leaderboard/leaders/).
...
The [double-bottom base](https://www.investors.com/how-to-invest/investors-corner/what-is-double-bottom-base-biotech-stocks/) is a bit different. The stock forms a cup pattern, but makes another correction before it reaches new highs. The second bottom usually is lower than the first.
...
![ica_020817](https://www.investors.com/wp-content/uploads/2017/02/ICa_020817-932x1024.png)
...
Meanwhile, stocks were taking off and leading growth names were bursting out of bases after [the market followed through](https://www.investors.com/how-to-invest/investors-corner/how-to-find-next-stock-market-bottom/) on March 17, 2003, Day 4 of a new rally attempt. On that day, the Nasdaq soared 3.9% in higher turnover; the S&P 500 gushed 3.5% higher.
...
On the breakout day past 19, VistaCare showed decent ratings on [IBD Stock Checkup](https://research.investors.com/stock-checkup/) despite being such a young new public company: a 72 Composite, 80 EPS, 78 RS and A- for Accumulation/Distribution.

Investors who bought at the correct buy point stood to more than double their money by year's end.

_A version of this column was originally published on April 16, 2010. VistaCare was acquired by Odyssey HealthCare in March 2008._
...
[Invest Time In The Cup-With-Handle Pattern](https://www.investors.com/how-to-invest/investors-corner/the-basics-how-to-analyze-a-stocks-cup-with-handle/)

[How To Read Charts Like A Pro: Focus On Daily Chart? Weekly? No, Both](https://www.investors.com/how-to-invest/investors-corner/cup-with-handle-basics-analyze-both-daily-weekly-stock-charts/)
