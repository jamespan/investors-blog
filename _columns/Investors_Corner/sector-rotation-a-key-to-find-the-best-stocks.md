...
According to IBD founder [William O'Neil's](https://www.investors.com/news/william-oneil-legendary-investor-ibd-founder-canslim-creator/) research, 37% of a stock's price performance is tied to the industry group that it's in and an additional 12% from the industry sector's performance. There are 11 S&P 500 sectors, and IBD breaks them down further into 33 sectors. Within the sectors, IBD further breaks down the market by 197 industry groups.
...
To start, go to [IBD Data Tables](https://www.investors.com/ibd-data-tables/). Here you will find [IBD Smart NYSE + Nasdaq Tables](https://www.investors.com/data-tables/ibd-smart-nyse-nasdaq-tables-sep-18-2023/), which classify the 33 IBD sectors by performance.

Click on a sector to view the list of stocks in it. If a stock is strong enough to be an [IBD Sector Leader](https://research.investors.com/stock-lists/sector-leaders), it will be displayed at the top of the sector listings. The Smart Tables show how each sector has performed each day and year-to-date. Pay close attention to sectors moving into the top six. Historically, that's where most leading stocks are found.

Next, look for [IBD Industry Group Rankings](https://www.investors.com/data-tables/industry-group-rankings-sep-18-2023/). This data is more valuable because it shows the ranking of all 197 IBD industry groups, plus their spots three and six weeks ago.

In [IBD MarketSurge](https://get.investors.com/marketsurge/?artProdLink=MarketSurge), the Related Information panel on the right side gives more detail on a stock's sector and group, including how a stock ranks vs. others in the group.
...
The [New High List](https://www.investors.com/data-tables/new-high-list-sep-18-2023/) identifies stocks by sector that hit new highs the prior day and provides their IBD [EPS Rating](https://www.investors.com/how-to-invest/investors-corner/growth-stocks-and-how-to-analyze-earnings-growth-using-ibd-eps-rating/). Study the sectors with most new highs and most new lows for clues on rotation.

## Sector Charts, ETFs

Checking the S&P 500 sector ETFs gives insight into leaders and laggards. For this, check the [Stock Market Data page](https://www.investors.com/research/stock-market-data-dow-jones-sp-500-nasdaq-spdr-etfs/) of Investors.com. It includes charts of the major indexes and the 11 S&P sector funds for a visual assessment of sector performance.

The list of [IBD Top Sector ETFs](https://www.investors.com/data-tables/top-sector-etfs-sep-18-2023/) also keeps you in tune with top-performing sectors.

And read [The Big Picture](https://www.investors.com/category/market-trend/the-big-picture/) each day for analysis on sectors and the broad market.

Use these tools to help you spot sector rotation and new leaders. You will be a step ahead of the crowd.

_Follow Kimberley Koenig for more stock market news on X, the platform formerly known as Twitter, [@IBD_KKoenig](https://twitter.com/home)._
