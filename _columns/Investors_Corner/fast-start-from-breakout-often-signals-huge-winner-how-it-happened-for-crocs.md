...
But in an extended market with already narrow breadth, that can be easier said than done. Fortunately, IBD's [MarketSurge](https://get.investors.com/marketsurge/?artProdLink=MarketSurge) has you covered for those situations with the Power From Pivot flag.


A Second Chance For Crocs Stock
-------------------------------




If you're familiar with [IBD's eight-week hold rule](https://www.investors.com/how-to-invest/investors-corner/how-to-invest-8-week-hold-rule-helps-latch-on-to-big-winners/), then you already know about the Power From Pivot flag. This green flag appears when a stock has risen 20% or more within three weeks of breaking out from a base pattern. ("Pivot" is a wonky term for a buy point.)
...
To find the Power From Pivot list in MarketSurge, start with the list panel in the bottom-left corner of your charts.


Click "Reports" then "MarketSurge Growth 250." From there, select the folder named "G250-Pattern Recognition" and scroll until you find the Power From Pivot list. It's best to sort the list by Weekly Pivot Week to find the stocks that haven't gone up too much. A first- or second-stage base is preferable.


An 18-Month Climb In Crocs
--------------------------


By the way, Power From Pivot flags are plotted on weekly MarketSurge charts at the week the stock reaches the 20% jump from the buy point.


**![crocs crox](https://www.investors.com/wp-content/uploads/2024/02/IC022624-268x300.jpg)Crocs** ([CROX](https://research.investors.com/quote.aspx?symbol=CROX)) had a meteoric rise following the lows of the Covid bear market. In May 2021, a full year after retaking the 10-week line, the stock was still going strong.


It climbed 27% shortly after a six-week consolidation that formed in March and April **(1)**. The fast start was plotted in MarketSurge **(2).** With the green Power From Pivot flag, the eight-week hold rule was triggered. Crocs then formed a five-week flat base **(3)**.
