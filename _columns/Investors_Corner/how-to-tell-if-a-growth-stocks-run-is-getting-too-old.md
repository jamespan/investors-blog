...
Investors can tell the age of a stock advance by counting the number of bases in its chart. Typically, growth stocks make long-term advances that last roughly two years, usually ending with a bear market or market correction. Along the way, stocks typically form three or four [bases](https://www.investors.com/how-to-invest/investors-corner/best-stocks-to-buy-form-bullish-bases-before-big-price-gains/): price consolidations that mainly last seven weeks or longer.
...
To accurately gauge base stages, first make sure you know how to identify the [principal patterns](https://www.investors.com/how-to-invest/investors-corner/best-stocks-to-buy-form-bullish-bases-before-big-price-gains/), such as the flat base, [cup with handle](https://www.investors.com/how-to-invest/investors-corner/the-basics-how-to-analyze-a-stocks-cup-with-handle/) and [double bottom](https://www.investors.com/how-to-invest/investors-corner/what-is-double-bottom-base-biotech-stocks/).
...
[IBD MarketSurge](https://get.investors.com/marketsurge/?artProdLink=MarketSurge) offers an add-on that identifies most bases and their stage number. Weekly charts are best for counting bases.

## Growth Stock's 2020-21 Advance

**![](https://www.investors.com/wp-content/uploads/2022/02/IC2c_022822-300x161.jpg)CrowdStrike** ([CRWD](https://research.investors.com/quote.aspx?symbol=CRWD)) was a huge winner in the bull market that followed the Covid-19 outbreak. The first base formed during the market dive and rebound in February-April 2020 **(1)**.

The stock nearly doubled from that base to the next pattern, a [double bottom](https://www.investors.com/how-to-invest/investors-corner/stock-charts-difference-between-double-bottom-flat-base/) in July-August 2020 **(2)**. That second-stage base resulted in a 30% gain to the next base, a six-week [cup](https://www.investors.com/how-to-invest/investors-corner/corner-cup-without-handle/) in October and November **(3)**. The count was now at a third-stage.
...
_This article was originally published Feb. 25, 2023, and has been updated._
