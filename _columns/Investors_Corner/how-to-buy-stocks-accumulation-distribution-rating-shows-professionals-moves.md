...
The [Accumulation/Distribution Rating](https://www.investors.com/how-to-invest/investors-corner/stocks-funds-are-buying/) is a proprietary rating that measures daily price and [volume](https://www.investors.com/how-to-invest/investors-corner/stock-chart-analysis-study-volume-in-bases/) changes in institutional ownership of a stock for the prior 13 weeks.
...
Review this rating frequently; it's updated daily. It can be found in several places on the [IBD website](https://www.investors.com/) including [Stock Checkup](https://research.investors.com/stock-checkup/) and stock tables. It can also be found on [MarketSmith](https://docs.google.com/spreadsheets/d/19gVhaVclQPkVtQswmdmeCuv5D2Z-LQy8mq2h9swul8A/edit#gid=553383727&range=B23) in the left-hand side ratings box, as well as IBD Weekly, in the stock tables and mini-charts.

## How To Buy Stocks Using A/D Rating

![Inside corner Li Auto](https://www.investors.com/wp-content/uploads/2022/06/IC2c070422-279x300.jpg)Institutional buying can be a precursor to a stock breaking out to new highs.

In early July of 2022, **Li Auto** ([LI](https://research.investors.com/quote.aspx?symbol=LI)) had an Accumulation/Distribution Rating of A. Let's take a look at the daily chart of Li Auto at that time. The stock price gapped above the [50-day moving average](https://www.investors.com/how-to-invest/investors-corner/50-day-moving-average-identifies-buy-sell-signals/) May 31 after hitting a low on May 9.
...
The aerospace and defense industry group in July 2022 was under distribution after having a big run starting around the beginning of 2022. Examples included **Lockheed Martin** ([LMT](https://research.investors.com/quote.aspx?symbol=LMT)), which had a D rating. **General Dynamics** ([GD](https://research.investors.com/quote.aspx?symbol=GD)) dropped to an E rating, and **Northrop Grumman** ([NOC](https://research.investors.com/quote.aspx?symbol=NOC)) had a D- rating.
...
The A/D rating is one of the criteria in the IBD checklist in the [IBD Stock Checkup](https://research.investors.com/stock-checkup/nasdaq-li-auto-inc-ads-class-a-li.aspx) or MarketSmith that can be used to learn how to buy stocks, along with identifying the [buy point](https://www.investors.com/how-to-invest/investors-corner/the-best-stocks-have-crystal-clear-buy-points-heres-how-to-identify-them/) on the chart. Remember, we are looking to buy stocks in a confirmed market uptrend, so when the market is under pressure as it is now, it is a riskier time to buy stocks.

_This article was originally published July 1, 2022, and has been updated._
