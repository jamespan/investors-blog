...
Those were important findings that [IBD founder William O'Neil](https://www.investors.com/ibd-videos/videos/remembering-william-oneil) made in crafting his groundbreaking study on winning stocks. A smart investor identifies the top stocks in the top industries. And IBD tools are designed to do just that.
...
Broken up into 33 sectors, the [IBD Smart NYSE + Nasdaq Tables](https://www.investors.com/data-tables/ibd-smart-nyse-nasdaq-tables-sep-05-2023/) are organized by aggregate performance of each sector's stocks. This performance is measured over multiple time periods.
...
This is where another IBD tool — the [IBD Stock Checkup](https://research.investors.com/stock-checkup/nasdaq-zscaler-zs.aspx) — is your guide. It tells you where the stock ranks within its group in terms of IBD Composite Rating, EPS Rating and other ratings. The Checkup also gives some basic industry data.


The [stock quotes at Investors.com](https://research.investors.com/stock-quotes/nasdaq-zscaler-zs.htm) also show the stock's rank within its industry.
...
* [Groups With Highest % of Stocks at New High](https://www.investors.com/data-tables/groups-with-highest-of-stocks-at-new-high-sep-05-2023/) contains the industries with the largest portion of their member stocks making 52-week highs. You can use this to spot concentrations of strength. The list is updated daily.
* The [New Highs List](https://www.investors.com/data-tables/new-high-list-sep-05-2023/) helps you find stocks making 52-week highs. It's organized by sector, which makes it a good way to spot strong areas of the market.
...
* You can also look up which sector an industry belongs to with the [Find Your Group's Sector table](https://www.investors.com/data-tables/find-your-groups-sector-2022/) at Investors.com.
