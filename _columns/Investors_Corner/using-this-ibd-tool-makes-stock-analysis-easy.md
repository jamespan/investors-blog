...
Finding the next winning growth stock may be on your to-do list, but stock analysis can feel daunting. The [IBD Stock Checkup tool](https://research.investors.com/stock-checkup/) applies the [CAN SLIM](https://www.investors.com/how-to-invest/investors-corner/can-slim-stocks-how-to-find-stock-market-winners/) approach to evaluate stocks and offers more.
...
The analysis starts with a top-down approach and goes into a more granular level. The [Composite Rating](https://www.investors.com/how-to-invest/investors-corner/how-to-research-growth-stocks/) combines five IBD SmartSelect Ratings into one number, with 99 being the highest.
...
The M in the CAN SLIM investing strategy stands for [Market Direction](https://www.investors.com/how-to-invest/investors-corner/ibds-market-outlook-a-guide-to-the-different-designations/). IBD evaluates the major indexes' price and [volume](https://www.investors.com/how-to-invest/investors-corner/stock-chart-analysis-study-volume-in-bases/), and updates market direction daily. Three out of four stocks will follow the direction of the general market, so it's crucial to get this part right. The rule is to make new purchases only in a market uptrend.


Next, we are looking for companies in leading industries. The L in CAN SLIM stands for leader or laggard. We want companies in the top 40, but ideally in the top 20 of the 197 industries IBD tracks. According to "How to Make Money in Stocks," 37% of a stock's movement is tied to the [performance of the industry group](https://www.investors.com/how-to-invest/investors-corner/top-industry-groups-beget-top-stocks/) and another 12% comes from its sector. We are looking for an A or B Group Relative Strength Ratings.
