...
Let's take the cup with handle fashioned by **Baidu** ([BIDU](https://research.investors.com/quote.aspx?symbol=BIDU)) (see the chart below) in 2007. In the cup base, the high was 134.10 and the low was 92.80. Add the two prices together and divide by 2 and you get a base midpoint of 113.45. The handle showed a high of 132.80 and a low of 120.25, and its midpoint of 126.53 easily exceeded the cup's midpoint.

The [handle](https://www.investors.com/how-to-invest/investors-corner/the-basics-spot-traits-of-proper-handles-on-cup-patterns/) should also show a downward slope along at least a portion of its price lows, not an upward one.
...
![ic_bidu_010417](https://www.investors.com/wp-content/uploads/2017/01/IC_bidu_010417.png)
...
This, of course, is where all the above parameters lead if they appear correctly. The [buy point](https://www.investors.com/how-to-invest/investors-corner/chart-reading-basics-how-a-buy-point-marks-a-time-of-opportunity/) from a cup-with-handle base appears at the highest point of the handle. In the case of former big winner Baidu, the proper buy point during its May 14, 2007, breakout was 132.80, matching the handle's high of 132.80.
...
The [daily and weekly charts](http://research.investors.com/stock-charts/nasdaq-nasdaq-composite-0ndqc.htm?cht=pvc&type=DAILY) at both Investors.com and [MarketSmith](http://shop.investors.com/offer/splashresponsive.aspx?id=mssharpen-fixed&src=A012BF2) make heavy turnover easy to spot. Simply compare the day or week's volume with the moving average line drawn across the volume bars. An Investors.com chart will also tell you in real time how volume is running in comparison with typical level at that time of the trading session.
...
At that point, it makes sense to exit the stock, even if the [7%-8% loss-cutting sell rule](https://www.investors.com/how-to-invest/investors-corner/still-the-no-1-rule-for-stock-investors-always-cut-your-losses-short/) has not yet been triggered.

_A version of this column was first published July 9, 2010. Please follow Saito-Chung on Twitter at both @SaitoChung and @IBD_DChung for more on growth stocks, charts, breakouts, sell signals, and financial markets._
