...
Investor's Business Daily research shows that winning stocks usually report quarterly earnings growth of at least 25%. But profitability can be measured in different ways.
...
![smr ratings](https://www.investors.com/wp-content/uploads/2025/02/IC1c021025-251x300.jpg)A stock gets a letter grade from A to E based on the results. An A rating shows the stock is among the top 20% in the IBD database for this metric. But both A and B are equivalent to "pass" on the assessment. Also, if any of the measures shows accelerating growth, the SMR Rating will take that into account.
...
Use the rating with other tools that track the stock's performance, such as the [Relative Strength Rating](https://www.investors.com/how-to-invest/investors-corner/relative-strength-rating-stock-chart-analysis-helps-pick-outstanding-growth-stocks/) and tools such as the [relative strength line](https://www.investors.com/how-to-invest/investors-corner/relative-strength-line-gives-crucial-clues-about-stocks-ready-to-make-big-gains/#:~:text=Simply%20put%2C%20the%20relative%20strength,with%20the%20Relative%20Strength%20Rating.) and [moving averages](https://www.investors.com/how-to-invest/investors-corner/moving-averages-help-understand-stock-markets-direction-heres-how-to-use-them/). An understanding of [base patterns](https://www.investors.com/how-to-invest/how-to-read-stock-charts-understanding-technical-analysis/) and [buy points](https://www.investors.com/how-to-invest/investors-corner/chart-reading-basics-how-a-buy-point-marks-a-time-of-opportunity/) is also valuable.


The SMR Rating is part of a stock's overall [Composite Rating](https://www.investors.com/how-to-invest/investors-corner/how-to-research-growth-stocks/). It can be found on [IBD MarketSurge](https://get.investors.com/marketsurge/?artProdLink=MarketSurge), [IBD Stock Checkup](https://research.investors.com/stock-checkup/), IBD's stock tables and[IBD Leaderboard](https://leaderboard.investors.com/#/leaders/leadersnearabuypoint) charts.
...
[Discover Top Growth Stocks With IBD Leaderboard](https://leaderboard.investors.com/#/leaders/leadersnearabuypoint)
...
You should expect an institutional-quality company like **Palantir** ([PLTR](https://research.investors.com/quote.aspx?symbol=PLTR)) to have a strong SMR Rating. Indeed, its rating is currently an A and had that highest-possible mark even on Jan. 27, when many tech stocks sold off. On Tuesday, Palantir [soared to new highs on a bullish earnings report](https://www.investors.com/news/technology/palantir-stock-pltr-stock-palantir-earnings-q42024/).
