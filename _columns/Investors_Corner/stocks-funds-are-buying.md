...
It's especially important to check the Accumulation grade when you are researching a stock and studying the [quality of its base](https://www.investors.com/how-to-invest/investors-corner/how-to-trade-stocks-base-stock-charts/). Institutional buying tends to appear in bases before [stocks break out to new highs](https://www.investors.com/how-to-invest/investors-corner/chart-reading-basics-how-a-buy-point-marks-a-time-of-opportunity/). **TransUnion** ([TRU](https://research.investors.com/quote.aspx?symbol=TRU)) scored A and B ratings in nearly all of the 57 days it spent basing in late January to April 20, 2018, when it soared to a new high of 67.32.


Gains in heavy volume the weeks ended Feb. 16, March 9 and March 16 were evidence of major fund buying while the base took shape. [The breakout](https://www.investors.com/how-to-invest/investors-corner/chart-reading-basics-how-a-buy-point-marks-a-time-of-opportunity/) took TransUnion as high as 75.99 before the next base started.
...
Like any rating, there's always a lag if the stock sees abrupt changes. For example, on May 9, 2017, **Nvidia** ([NVDA](https://research.investors.com/quote.aspx?symbol=NVDA)) had lowly D- Accumulation rating. One day later, the chip company went to a C- when Nvidia shot up 18% in heavy volume to a new high.


On the flip side, **Meta Platforms** ([META](https://research.investors.com/quote.aspx?symbol=META)) was at new highs and gleaming with an A grade on July 25. (At that time it was still called Facebook and traded under the FB symbol.) That same evening, however, the company's earnings report spooked investors and shares plummeted 19% the next day.
...
You can quickly find the Accumulation/Distribution Rating for virtually any stock at IBD's website, namely in the stock quotes and [Stock Checkup](https://research.investors.com/stock-checkup/). Various data tables also include the rating. In the IBD Weekly print newspaper, it is found in the stock tables, plus it's in the mini-charts for [IBD 50](https://research.investors.com/stock-lists/ibd-50/), [Stock Spotlight](https://research.investors.com/stock-lists/stock-spotlight/), [Sector Leaders](https://research.investors.com/stock-lists/sector-leaders) and [IPO Leaders](https://research.investors.com/stock-lists/ipo-leaders/). Ratings are updated overnight.


*A version of this column was first published on Oct. 26, 2018, and has been updated.*
...
[Where Can You Find Top Stocks At Buy Points Right Now? Try This Premium IBD Service](https://www.investors.com/product/leaderboard/?artProdLink=Leaderboard)
