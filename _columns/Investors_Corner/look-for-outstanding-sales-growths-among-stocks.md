...
**Starbucks** ([SBUX](https://research.investors.com/quote.aspx?symbol=SBUX)) didn't become a screaming winner by cutting costs. Instead, it changed the way we think of coffee shops. **Costco Wholesale** ([COST](https://research.investors.com/quote.aspx?symbol=COST)), **Amazon.com** ([AMZN](https://research.investors.com/quote.aspx?symbol=AMZN)) and **eBay** ([EBAY](https://research.investors.com/quote.aspx?symbol=EBAY)) changed the way we shop. **Dell** ([DELL](https://research.investors.com/quote.aspx?symbol=DELL)), **Microsoft** ([MSFT](https://research.investors.com/quote.aspx?symbol=MSFT)) and **Intel** ([INTC](https://research.investors.com/quote.aspx?symbol=INTC)) changed the way we do practically everything.

What do the game-changing stocks have in common? Red-hot sales growth. As if everyone in America needed that \$3 coffee.

Outstanding sales growth ties into the N in CAN SLIM. It stands for New. Throngs don't flock to the same old, same old.
