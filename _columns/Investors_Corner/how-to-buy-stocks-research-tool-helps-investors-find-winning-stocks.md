...
IBD offers investors ample help, from finding stock ideas to conducting fundamental and technical analysis. Today, we'll focus on [IBD Stock Checkup](http://research.investors.com/stock-checkup/), a research tool to quickly analyze a stock's strengths and weaknesses.
...
You'll see near the top of Stock Checkup five tabs: [Composite Rating](https://www.investors.com/how-to-invest/investors-corner/how-to-research-growth-stocks/), [Earnings Per Share Rating](https://www.investors.com/how-to-invest/investors-corner/eps-rating-is-key-to-picking-great-stocks/), [Relative Strength Rating](https://www.investors.com/how-to-invest/investors-corner/relative-strength-rating-stock-chart-analysis-helps-pick-outstanding-growth-stocks/), [SMR Rating](https://www.investors.com/how-to-invest/investors-corner/how-to-find-top-stocks-2/) and [Accumulation/Distribution Rating](http://www.investors.com/how-to-invest/investors-corner/why-the-accumulationdistribution-rating-is-one-key-to-finding-great-stocks/). Clicking on each will show where the stock ranks in its industry group based on those ratings.
...
Let's take a look at **Microsoft** ([MSFT](https://research.investors.com/quote.aspx?symbol=MSFT)), an [IBD Leaderboard](https://leaderboard.investors.com/#/leaders/leadersnearabuypoint) and [IBD Long-Term Leader](https://www.investors.com/research/best-stocks-to-buy-now-long-term-stocks-ibd-long-term-leaders-list/) stock.
...
But what should give investors pause is the Market Direction and Industry Group section. The current outlook, [uptrend under pressure](http://www.investors.com/ibd-university/market-timing/action-plans/), is yellow. That means all stock purchases — not just Microsoft — are riskier than usual due to the market environment.
