...
与此同时，**Target** （[TGT](https://research.investors.com/quote.aspx?symbol=TGT)） 疲软的收益报告令标准普尔 500 指数承压。但该指数在盘中下跌近 1% 后收盘小幅走高。Target 在[未达到收益和收入](https://www.investors.com/news/target-earnings-walmart-tjx-q3-target-stock-tjx-stock/)预期并且前景疲软后下跌超过 20%。
