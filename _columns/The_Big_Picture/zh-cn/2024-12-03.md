...
在回调时买入领先者是完全合理的策略。这里的问题是，由于有这么多延长的股票，大多数股票仍然远高于其 50 天和 10 周的线。在回调至 [21 天指数移动平均线](https://www.investors.com/how-to-invest/investors-corner/what-is-the-21-day-exponential-moving-average/)后买入组长通常效果良好。但这是一个风险更大的入口。
