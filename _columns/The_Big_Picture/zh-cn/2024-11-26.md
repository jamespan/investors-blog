...
回调后，亚马逊从 201.20 的替代条目回到买入区域。（它在 11 月 1 日的 195.37 句柄条目中名列前茅。Microsoft 在试图突破下跌趋势时突破了几个短期移动平均线。Meta Platforms 仅比其高点低 5%，因为它形成了一个平坦的基础。Meta 试图收复其 50 天移动平均线，但收盘价略低于该线。
