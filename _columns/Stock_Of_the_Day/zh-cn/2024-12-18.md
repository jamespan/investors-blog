...
Analysts moved price targets on EXLS stock sharply higher at the end of October, FactSet shows. That followed an earnings beat-and-raise from the **Nvidia** ([NVDA](https://research.investors.com/quote.aspx?symbol=NVDA)) artificial intelligence partner.[重试
  
...
"The ongoing execution of our data and AI-led strategy enabled us to accelerate our growth," EXL CEO Rohit Kapoor said in an Oct. 29 earnings release.[重试
  
...
ExlService Stock Finds Key Support Near Buy Point[重试
  
...
The AI play showed a 47.37 [buy point](https://www.investors.com/ibd-university/how-to-buy/) from a flat base, formed entirely above the 50-day moving average, according to [MarketSurge charts](https://marketsurge.investors.com). But it neared a test of the 50-day line into Wednesday's close.[重试
  
...
Shares closed around 7% below the entry, which marks the Nov. 27 record high.[重试
  
...
The [relative strength line](https://www.investors.com/how-to-invest/investors-corner/growth-stocks-breakout-specialty-tool-relative-strength-line/) for ExlService stock has flattened out a bit after surging since June. If the RS line moves to new highs as the AI play tries to break out, it would send a positive signal. A rising RS line means that a stock is outperforming the S&P 500 index. It is the blue line in the chart provided.[重试
  
...
ExlService Earnings Acceleration[重试
  
...
Additionally, EXLS shows an RS Rating of 91 and EPS Rating of 95, also out of a best-possible 99.[重试
  
...
The company boasts two quarters of accelerating earnings and sales growth.[重试
  
