...
SharkNinja 第二天 **（2）** 再次跳空，但在接下来的几周内几乎没有放弃任何失地。在连续三天走低和上行反转后，我们在 [SwingTrader](http://shop.investors.com/offer/splashresponsive.aspx?id=SwingTrader&src=A011LPH) 上建立了半仓**（3）。**
...
使用入场日的低点作为止损有点紧，只有 1.6%。相反，我们使用了 8 月 9 日的低点，因为它包含走势 **（2）。**
...
SharkNinja 再次下跌三天，然后又一次上行反转 **（4）。**我们利用这个机会在获得大约 1% 的收益后增加了四分之一的位置。一旦股票清除了 92 上方的阻力位，我们又增加了四分之一 **（5）。**
...
重要的是，每次购买都处于更高的水平。我们不会平均下降。此外，我们以更高的价格选择更少的股票。这有助于避免您的平均成本飙升太多。最终结果是，在三次购买后，我们获得了全额头寸，平均成本约为 91，与我们最初的进入市场相差不到 1%。
...
随着 SharkNinja 走高，它以有序的方式行事，沿途在其 10 天移动平均线找到支撑。尽管如此，在最初入场 **（6）** 获得近 15% 的收益后，我们开始锁定四分之一头寸的部分利润。
...
在暂停和略微下跌后，我们又起飞了一个季度 **（7），**然后在它创下新高 **（8）** 后又起飞了一个季度。由于我们的头寸缩小到四分之一的规模和大量的缓冲，我们可以在我们决定锁定最终利润之前给剩余部分一些空间。
...
但在暂停一周后，我们决定在股价再次跳空升至新高后回购一个季度 **（9）。**是的，我们以比上次销售更高的价格添加，但金额很小，因此我们的平均成本仍然有足够的缓冲。
