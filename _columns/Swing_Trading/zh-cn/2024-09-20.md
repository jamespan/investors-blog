...
法拉利以 439.68 的价格加入 [SwingTrader](http://shop.investors.com/offer/splashresponsive.aspx?id=SwingTrader&src=A011LPH) 作为半位，随着它全天的进展，我们扩大了它。当我们在第一次购买时取得了 2.25% 的进展，我们又增加了一个季度，然后又增加了一个季度，当时我们又取得了 1% 的进展。虽然我们那天买了 3 次，但我们的平均成本为 445.67，股票收于 452.90。我们有一个完整的头寸，上涨了 1.6%，这为我们提供了一些选择，以防出现暂时的疲软。
...
几天后，我们最后一次退出，当时法拉利似乎停滞在其 21 天线 **（8）** 下方。早期的扩大和早期的获利回吐相结合，使交易非常宽容，并为我们留下了 4.5% 的收益。但这可能还不是全部。跳空回 21 日线 **（9）** 上方给了我们另一个看好股票的机会，我们开始了新的半仓。
